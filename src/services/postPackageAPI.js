    ...
    createPackage: async (packageData) => {
        try {
            ...
            return {
                success: true,
                data: response,
                message: response.Message || 'Tạo gói đăng tin thành công'
            };
        } catch (error) {
    ...
    updatePackage: async (packageData) => {
        try {
            ...
            return {
                success: true,
                data: response,
                message: response.Message || 'Cập nhật gói đăng tin thành công'
            };
        } catch (error) {
    ...
    deletePackage: async (id) => {
        try {
            ...
            return {
                success: true,
                data: response,
                message: response.Message || 'Xóa gói đăng tin thành công'
            };
        } catch (error) {
